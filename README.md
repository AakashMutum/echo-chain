# 🔗 Echo Chain - Complete Documentation

> **A full-stack Web3 application for decentralized decision management with on-chain accountability** 🚀✨
...
| **Backend** 🗄️ | Supabase (PostgreSQL, Auth), Next.js API Routes |
| **Blockchain** ⛓️ | Solidity 0.8.x, Hardhat, Ethers.js, wagmi, RainbowKit |
| **Tools** 🛠️ | ESLint, Prettier, Git, pnpm |
